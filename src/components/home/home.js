...
export function HomePage(){
  ...
  <div className="container-fluid">
    ...
    {/* https://clockify.me/assets/images/brand-assets/clockify-logo-preview.png */}
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        {/* <li className="nav-item">
        <Link to='features' className="nav-link " href="#"   aria-expanded="false">
        FEATURES
          </Link>
        </li> */}
...
{/* footeragash */}
        ...
        <div className="footDiv d-flex flex-lg-column flex-column col-lg-12 col-12 justify-content-center align-items-center p-5">
            <h1 className="text-center">Start tracking time with TickTraq</h1>
                ...
                <a href='/signup' className="accountBtn col-lg-2 btn text-decoration-none">CREATE FREE ACCOUNT</a>
        ...
        <div className="footMainDiv text-start pt-5 h-100 gap-1 d-flex flex-lg-row col-12 gap-5 flex-column align-text-center mx-auto col-lg-8">
            <div className="col-lg-4">
                <div className="companyLogin text-start col-lg-8 col-10 mx-auto">
                    <img className="col-lg-8 ms-4" src="https://i.postimg.cc/tgvZhYP7/Light-Mode-Logo.jpg"></img>
                    <p className="col-lg-12">"Empower Your Productivity, One Moment at a Time - Track, Manage, Succeed!"</p>
                    <p></p>
                    <p className="mt-5 ms-5"><a href='/signup' className="text-decoration-none">SIGN UP FREE</a></p>
                    <p className="mt-2 ms-5"><a href='/login' className="text-decoration-none" >LOGIN NOW</a></p>
                </div>
            </div>
                    ...
                    <div className="solutionDiv col-lg-6 col-6">
                        ...
                        <div className="col-lg-12 dropdownDiv dropdown-menu" aria-labelledby="dropdownMenuButton">
                           ...
                           <div >
                            ...
                            <div>
                                <h6>Timesheet Software</h6>
                                <p>Job Tracking</p>
                                <p>Time Entry System</p>
                            </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div className="ms-3 col-lg-12 dropdown">
                                                ...
                                                <div >
                                                        ...
                                                        <p>Time Tracking Invoicing</p>
                                                        <p>Payroll Hours Tracker</p>
                                                    </div>    
                                                    <div>
                                                        <h6>Leave & Vacation Tracker</h6>
                                                        <h6>Attendance Tracker</h6>
                                                        <p>Activity Log</p>
                                                        <p>Time Billing App</p>
                        ...
                        {/* ****Management******* */}
                                        ...
                                        <div className="d-lg-flex text-start justify-content-center gap-2 ">
                                            ...
                                            <div>
                                                <h6>Project Scheduling</h6>
                                                <p>Goal Tracker</p>
                                                <p>Overtime Tracker</p>
                        ...
                        {/* ****Industry******* */}
                                        ...
                                        <div className="d-lg-flex text-start justify-content-center gap-2 ">
                                            ...
                                            <div>
                                                <h6>Freelance Time Tracking</h6>
                                                <p>Construction Time Tracking</p>
                                                <p>Developer Time Tracking</p>
                                                <p>Team Time Management</p>
                                            </div>
                                            </div>
                                        </div>
                                        </div>
...
{/* ******Company***** */}
                    <div className="d-flex col-lg-5 gap-5 col-9 me-5">
